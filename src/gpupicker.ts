...
export default class GPUPicker {
  ...
  getColorBufferCallback: any
  getPickColorBuffer: any
  currentPickedMesh = null //The idea is to only color change a mesh that is hit on main scene
